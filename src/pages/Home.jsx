...
import { skills, services } from '@config/skills';
    ...
    <main className="pt-20">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden bg-grid">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-20">
          ...
          <div className="z-10">
            ...
            >
              <span className="gradient-text-white">Hi, I am</span>
              <br />
      ...
      <section className="section-padding max-w-7xl mx-auto px-6">
        <SectionHeading
          ...
          subtitle="Battle-tested tools I use to build world-class products."
        />
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 justify-center relative z-10">
              <button onClick={open} className="btn-primary px-10 py-4 text-base">
                Start a Project
              </button>
              <Link to="/contact" className="btn-ghost px-10 py-4 text-base">
                Schedule a Call
              </Link>
            </div>
          </motion.div>
